...
export function ChooseByIntention() {
  ...
  return (
    <section className="py-14 sm:py-20 md:py-24 border-y border-[#E8D5B0] relative" style={{ backgroundColor: '#FFF8F0' }}>
      {/* OM Section Divider */}
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10">
        ...
        {/* Tab Strip */}
        <div className="flex overflow-x-auto hide-scrollbar border-b border-[#E8D5B0] mb-8 sm:mb-12 md:mb-16 -mx-4 px-4 md:mx-0 md:px-0 md:justify-center">
              ...
              <button
                ...
                className={`pb-3 sm:pb-4 whitespace-nowrap text-sm sm:text-base md:text-lg font-heading transition-all border-b-2 shrink-0 ${
                  activeTab === tab.id
                    ...
                    : 'border-transparent text-[#6B5A3E] hover:text-[#2D2400]'
                }`}
              >
                {tab.label}
              </button>
        ...
        {/* Content */}
        <div className="bg-white rounded-2xl sm:rounded-3xl p-5 sm:p-8 md:p-16 flex flex-col lg:flex-row items-center gap-8 sm:gap-10 lg:gap-24 border border-[#E8D5B0] shadow-[0_8px_40px_rgba(201,151,58,0.08)] relative overflow-hidden">
          ...
          <div className="flex-1 max-w-xl relative z-10 w-full">
            ...
            <h3 className="font-display text-xl sm:text-2xl md:text-3xl lg:text-4xl text-[#2D2400] mb-4 sm:mb-6 leading-snug sm:leading-tight">
              {activeData.desc}
            </h3>
            <p className="text-[#6B5A3E] font-body text-sm sm:text-base md:text-lg mb-6 sm:mb-8 md:mb-10 leading-relaxed">
            ...
            <a href="#" className="inline-flex items-center gap-2 sm:gap-3 px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-gold to-gold-soft text-white rounded-full font-heading font-bold uppercase tracking-widest text-xs sm:text-sm hover:shadow-[0_0_20px_rgba(201,151,58,0.4)] transition-all">
          ...
          <div className="flex-1 w-full grid grid-cols-2 gap-3 sm:gap-4 relative z-10">
            <div className="col-span-2 aspect-[2/1] rounded-xl sm:rounded-2xl overflow-hidden border border-[#E8D5B0] shadow-lg relative group">
            ...
            <div className="aspect-square rounded-xl sm:rounded-2xl overflow-hidden border border-[#E8D5B0] shadow-lg relative group">
            ...
            <div className="aspect-square rounded-xl sm:rounded-2xl overflow-hidden border border-[#E8D5B0] shadow-lg relative bg-[#FFF8F0] flex flex-col items-center justify-center p-3 sm:p-6 text-center group hover:border-gold transition-colors cursor-pointer">
               <div className="absolute inset-0 bg-mandala opacity-10 pointer-events-none" />
               <img src={activeImages[2]} alt="Single Bead Focus" className="w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 rounded-full object-cover mb-2 sm:mb-4 border-2 border-gold/40 shadow-[0_0_15px_rgba(201,151,58,0.3)]" />
               <span className="font-display text-sm sm:text-lg md:text-xl text-gold mb-1 sm:mb-2 relative z-10">Explore all</span>
               <span className="text-[10px] sm:text-xs font-heading uppercase tracking-widest text-[#6B5A3E] group-hover:text-[#2D2400] transition-colors relative z-10">View collection</span>
            </div>
          </div>
