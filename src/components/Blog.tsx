...
function AstroBackground() {
  ...
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden">
      {/* Deep space gradient wash, tuned to the cream/gold palette */}
      <div
...
export function Blog() {
  ...
  return (
    <section className="py-14 sm:py-20 md:py-24 bg-[#FFF8F0] relative overflow-hidden">
      {/* Background lightened using cream/gold tones,
          fading from lighter at the top to the base tone lower down */}
      <div className="absolute inset-0 bg-gradient-to-b from-[#FAF3E8]/30 via-[#FAF3E8]/10 to-transparent pointer-events-none" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8">
          ...
          <div className="lg:col-span-7 group cursor-pointer">
            <div className="relative aspect-[16/9] rounded-xl sm:rounded-2xl overflow-hidden border border-gold/20 mb-4 sm:mb-6">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#2D2400]/90 via-[#2D2400]/30 to-transparent" />
              {featured.badge && (
                <span className="absolute top-3.5 left-3.5 sm:top-5 sm:left-5 text-[9px] sm:text-[10px] font-heading font-bold uppercase tracking-widest bg-gold text-[#2D2400] px-2.5 sm:px-3 py-1 sm:py-1.5 rounded-full shadow-md">
                  {featured.badge}
                </span>
              )}
              <div className="absolute bottom-4 left-4 right-4 sm:bottom-6 sm:left-6 sm:right-6">
                ...
                <h3 className="font-display text-lg sm:text-2xl md:text-3xl text-white leading-tight group-hover:text-gold transition-colors">{featured.title}</h3>
              </div>
            </div>
