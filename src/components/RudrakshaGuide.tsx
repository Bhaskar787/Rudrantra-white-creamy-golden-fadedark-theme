    ...
    <section className="py-14 sm:py-20 md:py-24 bg-[#FFF8F0] min-h-screen relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-10 sm:mb-14 md:mb-20 max-w-3xl mx-auto">
          ...
          <p className="text-[#2D2400]/80 font-body text-sm sm:text-base md:text-lg leading-relaxed mt-4 sm:mt-6 px-2">
