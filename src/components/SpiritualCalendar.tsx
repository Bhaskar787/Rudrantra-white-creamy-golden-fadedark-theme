...
export function SpiritualCalendar() {
  return (
    <section className="py-14 sm:py-20 md:py-24 lg:py-28 border-t border-[#E8D5B0] overflow-hidden relative" style={{ backgroundColor: '#FFFAF4' }}>
      {/* OM Section Divider */}
      ...
      <div className="absolute top-0 right-0 w-1/2 h-full bg-mandala opacity-[0.04] pointer-events-none" />
      
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        
        <div className="text-center mb-10 sm:mb-14 md:mb-16 max-w-3xl mx-auto">
          <span className="text-[9px] sm:text-[10px] md:text-xs font-heading font-bold uppercase tracking-widest text-gold border border-gold/30 px-4 sm:px-5 py-1.5 sm:py-2 rounded-full inline-block mb-4 sm:mb-6 shadow-sm bg-gold/5">
          ...
          <p className="text-[#6B5A3E] font-body text-sm sm:text-base md:text-lg leading-relaxed px-2">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6 md:gap-8">
          {events.map((ev, i) => {
            ...
            return (
              <div 
                key={i} 
                className="bg-white border border-[#E8D5B0] rounded-2xl p-6 sm:p-7 md:p-8 transition-all duration-500 hover:border-gold/50 hover:shadow-[0_8px_30px_rgba(201,151,58,0.12)] group flex flex-col justify-between relative overflow-hidden"
              >
                ...
                <div>
                  ...
                  <div className="flex items-center justify-between mb-5 sm:mb-6">
                    <span className="text-[9px] sm:text-[10px] font-heading font-bold tracking-widest text-white uppercase bg-gold px-2.5 sm:px-3 py-1 rounded shadow-sm">
                      {ev.label}
                    </span>
                    <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-full border border-gold/30 bg-[#FFF8F0] flex items-center justify-center text-gold group-hover:bg-gold group-hover:text-white transition-colors duration-500 shrink-0">
                      <IconComponent className="w-4 h-4 sm:w-5 sm:h-5" />
                    </div>
                  </div>

                  <h3 className="font-display text-base sm:text-lg md:text-xl text-[#2D2400] mb-2 sm:mb-3 leading-snug group-hover:text-gold transition-colors">
                    {ev.name}
                  </h3>
                  <p className="text-[#6B5A3E] font-body text-xs sm:text-sm leading-relaxed">
                    {ev.desc}
                  </p>
                </div>

                {/* Bottom divider bar */}
                <div className="mt-5 sm:mt-6 pt-4 sm:pt-5 border-t border-[#E8D5B0]">
                  <span className="text-[9px] sm:text-[10px] font-heading font-bold uppercase tracking-widest text-gold/60">
                    Energize on this day
                  </span>
                </div>
              </div>
            );
