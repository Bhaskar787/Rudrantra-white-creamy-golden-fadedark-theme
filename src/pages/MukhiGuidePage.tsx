  ...
  return (
    <section className="py-14 sm:py-20 md:py-24 bg-[#FFF8F0] min-h-screen relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <Link
          href="/"
          className="inline-flex items-center gap-2 text-gold/70 hover:text-gold font-heading text-[10px] sm:text-xs font-bold uppercase tracking-widest mb-8 sm:mb-12 transition-colors"
        >
